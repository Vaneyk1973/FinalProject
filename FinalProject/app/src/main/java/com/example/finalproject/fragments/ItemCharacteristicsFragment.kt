...
class ItemCharacteristicsFragment(val item: Item, val mode:Boolean=true):Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        img.setImageBitmap(Bitmap.createScaledBitmap(MainActivity.textures[6][item.category],
